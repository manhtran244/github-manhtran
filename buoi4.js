...
// };
// console.log(ex3);
// console.log("3.1. The data type of the outermost layer: Object"); // Vì ngoặc ngoài cùng là khai báo 1 object
// console.log(
//   "3.2. The hits property is where the job results are stored: Array"
// ); // Vì ngoặc của hits là khởi tạo 1 array
// console.log(
...
//     console.log("Benefits: " + hit.benefits); // không in được array:((((
//     console.log("Skills: " + hit.skills);
//     console.log("Requirement: " + hit.jobRequirement)
//     console.log("===============")
// }
//4.1

// let words = ['debug','done', 'defect', 'pm', 'ui/ux'];

// alert('Hi there, this is dev dictionary');
// let ask = prompt('Enter keyword');

// if(ask==words[0]){
//     alert('debug: the process of figuring in out why your program has a certain error and how to fix it');
// }else{
//     alert('we cannot find your word: '+ask);
// }

//4.2

// let defi = {
//     debug: 'the process of figuring in out why your program has a certain error and how to fix it',
//     done: 'when your task is complete, the only thing have to do is to wait for users to use it(no addition codes or action needed)',
//     defect: "the formal word for'error' ",
//     pm: 'the dhort version of Project Manager, the person in charge of the final result of a project',
//     uiux: 'UI means Users Inteface, UX means Users Experience, are the process to define how your product looks and feels',
// }
// alert('Hi there this is dev dictionary')
// while(true){
//     let ask = prompt('Enter a key word: ');
//     for( var display in defi){
//        if(ask==display){
//         alert(ask +': '+defi[display]);
//         break;
//        }
//     }
//     if(ask != display){
//         let upd = prompt( 'We could not find your word: ' + display + ' leave your explanation');
//         alert('Done');
//         defi[ask]=upd;
//     }
// }
...
// }
// let choice = prompt('Enter your category? ');
